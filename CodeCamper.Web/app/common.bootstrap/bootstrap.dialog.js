...
(function (App) {
    ...
    (function (Shared) {
        ...
        Shared.commonBootstrapModule.factory(BootstrapDialog.serviceId, ['$modal', '$templateCache',
            function ($modal, $templateCache) { return new BootstrapDialog($modal, $templateCache); }]);
